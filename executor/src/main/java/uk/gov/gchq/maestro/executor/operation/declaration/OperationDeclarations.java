...
package uk.gov.gchq.maestro.executor.operation.declaration;
...
public class OperationDeclarations {
    ...
    public static OperationDeclarations fromPaths(final String paths) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to load element definitions from paths: " + paths + ". Due to " + e.getMessage(), e);
        }
    ...
    public static OperationDeclarations fromJson(final byte[] json) {
        try {
            ...
            throw new RuntimeException("Failed to load element definitions from bytes. Due to " + e.getMessage(), e);
        }
    }
