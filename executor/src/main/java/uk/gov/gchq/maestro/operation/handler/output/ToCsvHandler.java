 ...
 * input {@link Iterable}.
 */
public class ToCsvHandler<T> implements OutputOperationHandler<ToCsv<T>, Iterable<? extends String>> {
    @Override
    public Iterable<? extends String> doOperation(final ToCsv<T> operation,
