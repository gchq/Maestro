...
import static uk.gov.gchq.maestro.executor.operation.handler.named.AddNamedOperationHandler.OPERATION_NAME;
...
public class AddNamedOperationHandlerBasicTest extends MaestroHandlerBasicTest<AddNamedOperationHandler> {
    ...
    protected String getJSONString() {
        return "{\n" +
                "  \"class\" : \"uk.gov.gchq.maestro.executor.operation.handler.named.AddNamedOperationHandler\",\n" +
                "  \"fieldDeclaration\" : {\n" +
