 ...
 * {@link MaestroRuntimeException}s.
 */
@Provider
public class GafferRuntimeExceptionMapper implements ExceptionMapper<MaestroRuntimeException> {

    @Override
    public Response toResponse(final MaestroRuntimeException gre) {
