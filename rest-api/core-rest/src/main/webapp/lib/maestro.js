...
function loadExample(exampleButton){
    ...
    exampleUrl = version + "/executor/operations/" + classPathParam + "/example";
...
function hideJobsIfRequired() {
    $.get(getVersion() + '/executor/operations/uk.gov.gchq.maestro.operation.impl.job.GetJobDetails')
    .fail(function() {
