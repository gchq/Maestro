 ...
 * {@link uk.gov.gchq.maestro.commonutil.exception.MaestroRuntimeException}s.
 */
@Provider
public class MaestroRuntimeExceptionMapper implements ExceptionMapper<MaestroRuntimeException> {

    @Override
    public Response toResponse(final MaestroRuntimeException mre) {
        final Error error = ErrorFactory.from(mre);
