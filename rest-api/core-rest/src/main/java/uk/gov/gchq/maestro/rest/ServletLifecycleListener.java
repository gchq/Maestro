 ...
 *          &lt;web-app&gt;
 *              &lt;listener&gt;
 *                 &lt;listener-class&gt;uk.gov.gchq.maestro.rest.ServletLifecycleListener&lt;/listener-class&gt;
 *              &lt;/listener&gt;
 *          &lt;/web-app&gt;
 *      &lt;/xml&gt;
 *     }
...
public class ServletLifecycleListener implements ServletContextListener {
     ...
     * being shut down before the ShutdownHooks run. All Maestro services should use this class
     * rather than Shutdown hooks if they want to run Maestro in a servlet such as JBOSS or Tomcat.
     * @param servletContextEvent the context event
     */
    @Override
