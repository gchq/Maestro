...
public final class FederatedStoreConstants {
    // Operation options
    public static final String KEY_OPERATION_OPTIONS_GRAPH_IDS = "maestro.federatedstore.operation.graphIds";
    public static final String KEY_SKIP_FAILED_FEDERATED_STORE_EXECUTE = "maestro.federatedstore.operation.skipFailedFederatedStoreExecute";
