...
if [ "$RELEASE" == 'true' ] && [ "$TRAVIS_BRANCH" == 'master' ] && [ "$TRAVIS_PULL_REQUEST" == 'false' ]; then
    ...
    if [[ "$POM_VERSION" == *SNAPSHOT ]]; then
        ...
        sed -i'' -e 's/^maestro.version=.*/maestro.version='$RELEASE_VERSION'/'rest-api/core-rest/src/main/resources/version.properties
        ...
        sed -i'' -e 's/^maestro.version=.*/maestro.version='$NEW_GAFFER_VERSION'/' rest-api/core-rest/src/main/resources/version.properties
        rm -f rest-api/core-rest/src/main/resources/version.properties-e
