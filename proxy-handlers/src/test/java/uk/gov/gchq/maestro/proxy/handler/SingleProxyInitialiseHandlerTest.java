...
import uk.gov.gchq.maestro.executor.helper.MaestroInitialiseHandlerBasicTest;
...
public class SingleProxyInitialiseHandlerTest extends MaestroInitialiseHandlerBasicTest<SingleProxyInitialiseHandler> {
    ...
    protected String getJSONString() {
        return "{\n" +
                "  \"class\" : \"uk.gov.gchq.maestro.proxy.handler.SingleProxyInitialiseHandler\"\n" +
                "}";
    }

    @Test
    public void shouldNotHaveNullFieldDeclarations() throws Exception {
        Assert.assertNotNull(getTestHandler().getFieldDeclaration());
    }
}
