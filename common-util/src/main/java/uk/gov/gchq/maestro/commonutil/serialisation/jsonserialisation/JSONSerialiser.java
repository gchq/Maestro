 ...
 * to set the maestro.serialiser.json.class property in your ExecutorProperties or
 ...
 * maestro.serialiser.json.modules property in your ExecutorProperties or
...
public class JSONSerialiser {
    public static final String JSON_SERIALISER_CLASS_KEY = "maestro.serialiser.json.class";
    /**
     * CSV of {@link JSONSerialiserModules} class names. These modules will
     * be added to the {@link ObjectMapper}.
     */
    public static final String JSON_SERIALISER_MODULES = "maestro.serialiser.json.modules";
    public static final String DEFAULT_SERIALISER_CLASS_NAME = JSONSerialiser.class.getName();

    public static final String STRICT_JSON = "maestro.serialiser.json.strict";
...
//        mapper.registerModule(CloseableIterableDeserializer.getModule()); //TODO THIS Should go in config not code
    ...
    /**
     * @param stream the {@link InputStream} containing the bytes of the object to deserialise
     * @param clazz  the class of the object to deserialise
     * @param <T>    the type of the object
     * @return the deserialised object
     * @throws SerialisationException if the bytes fail to deserialise
    ...
    /**
     * @param content the {@link String} containing the bytes of the object to deserialise
     * @return the deserialised object
     * @throws SerialisationException if the bytes fail to deserialise
     */
