...
import uk.gov.gchq.maestro.commonutil.stream.StreamSupplier;

import java.util.stream.Stream;

/**
 * A {@link uk.gov.gchq.maestro.commonutil.iterable.CloseableIterable} which uses
...
public class StreamIterable<T> implements CloseableIterable<T> {
    ...
    /**
     * Get a {@link Stream} from the
     * {@link uk.gov.gchq.maestro.commonutil.stream.StreamSupplier}.
     * <p>
