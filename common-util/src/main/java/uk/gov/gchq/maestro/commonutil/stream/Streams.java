...
import uk.gov.gchq.maestro.commonutil.iterable.StreamIterable;
import uk.gov.gchq.maestro.commonutil.iterable.StreamIterator;
...
/**
 * Utility class to help with the usage of the Java 8 Streams API in Maestro.
 */
