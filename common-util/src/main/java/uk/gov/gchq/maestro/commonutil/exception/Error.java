...
import uk.gov.gchq.maestro.commonutil.exception.serialisation.StatusDeserialiser;
import uk.gov.gchq.maestro.commonutil.exception.serialisation.StatusSerialiser;

/**
 * Simple serialisable POJO for containing details of errors.
 * An {@link Error} object is typically
