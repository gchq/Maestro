...
/**
 * A {@code TransformIterable} allows {@link Iterable}s to be lazily validated and transformed without
...
public abstract class TransformIterable<I, O> implements CloseableIterable<O> {
    ...
    /**
     * Constructs an {@code TransformIterable} with the given input {@link Iterable} and no validation.
     *
    ...
    /**
     * Constructs an {@code TransformIterable} with the given input {@link Iterable} and
    ...
    /**
     * Constructs an {@code TransformIterable} with the given input {@link Iterable},
    ...
    /**
     * @return an {@link Iterator} that lazy transforms the I items to O items
     */
    @Override
